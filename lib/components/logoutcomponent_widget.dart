...
class LogoutcomponentWidget extends StatefulWidget {
  const LogoutcomponentWidget({Key key}) : super(key: key);
                        ...
                        children: [
                          Expanded(
                            child: Padding(
                              ...
                              child: Text(
                                'Please confirm thqt you would like to log out of your Apayo account.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyText2
                                    .override(
                                      fontFamily: 'Outfit',
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                await signOut();
                                context.goNamedAuth('Lets_log_in', mounted);
                              },
                              text: 'Logout',
                              options: FFButtonOptions(
                                width: 150,
