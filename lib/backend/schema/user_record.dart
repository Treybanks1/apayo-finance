...
abstract class UserRecord implements Built<UserRecord, UserRecordBuilder> {
  ...
  @nullable
  @BuiltValueField(wireName: 'Cardcompany')
  DocumentReference get cardcompany;

  @nullable
  DocumentReference get cardnumber;

  @nullable
  DocumentReference get cardbalance;
