...
class AppStateNotifier extends ChangeNotifier {
  ApayoFirebaseUser initialUser;
  ApayoFirebaseUser user;
  ...
  void update(ApayoFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'Lets_log_in',
              path: 'letsLogIn',
              builder: (context, params) => LetsLogInWidget(),
            ),
            FFRoute(
              name: 'sign_up',
              path: 'signUp',
              ...
              ? Container(
                  ...
                  child: Builder(
                    builder: (context) => Image.asset(
                      'assets/images/1_Light_splash_screen_(1).jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                )
